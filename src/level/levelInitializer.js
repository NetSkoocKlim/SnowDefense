...
export class LevelInitializer {
    static initLevels () {
        ...
        creator.addLevel(15,50, {common: 60, elite: null},{common: 1, elite: null}, 0, {common: 5, elite: null},level => {
            level.addWave(w =>
                w.setEndWaveTime(2)
                    .addSpawn(3, { common: [{ side: 1, count: 1 }], elite: null })
                    .addSpawn(8, { common: [{ side: 3, count: 1 }], elite: null })
                    .addSpawn(13, { common: [{ side: 1, count: 1 }, { side: 2, count: 1 }], elite: null })
            );
            level.addWave(w =>
                w.setEndWaveTime(2)
                    .addSpawn(4, { common: [{ side: 2, count: 2 }], elite: null })
                    .addSpawn(7, { common: [{ side: 2, count: 1 }], elite: null })
                    .addSpawn(16, { common: [{ side: 1, count: 2 }, { side: 3, count: 1 }], elite: null })
            );
            level.addWave(w =>
                w.setEndWaveTime(2)
                    .addRandomSpawn(3, 2.0, 1)
            );
        });

        creator.addLevel(20, 80,{common: 70, elite: null},{common: 2, elite: null}, 0, {common: 10, elite: null}, level => {
            level.addWave(w =>
                w.setEndWaveTime(10)
                    .addSpawn(3, { common: [{ side: 1, count: 2 }, { side: 3, count: 2 }], elite: null })
            );
            level.addWave(w =>
                w.setEndWaveTime(14)
                    .addSpawn(5, { common: [{ side: 2, count: 3 }, { side: 4, count: 3 }], elite:[ { side: 1, count: 1 } ]})
            );
            level.addWave(w =>
                w.setEndWaveTime(12)
        ...
        creator.addLevel(30, 100,{common: 100, elite: 150},{common: 2, elite: 5}, 0.05, {common: 5, elite: 50},level => {
            level.addWave(w =>
                w.setEndWaveTime(12)
                    .addSpawn(3, { common: [{ side: 1, count: 3 }, { side: 3, count: 3 }], elite:[ { side: 2, count: 1 }] })
        ...
        creator.addLevel(50, 150,{common: 100, elite: 150},{common: 3, elite: 6}, 0.1, {common: 10, elite: 60},level => {
            level.addWave(w =>
                w.setEndWaveTime(15)
