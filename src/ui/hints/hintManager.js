...
Перед тобой расстилаются бескрайние льдины, пронизывающий мороз и… наша крошечная, 
но очень важная база производства мороженого. Здесь, в самом центре этой ледяной пустоши, 
ты будешь стоять на страже сладости, которую так жаждут голодные песцы.`,
                target: {type: 'none'},
                trigger: {type: 'auto'},
                nextId: 'intro_2',
                modal: true,
            ...
            },
            {
                id: 'intro_2',
                group: 'intro',
                text: `Всё начинается прямо сейчас: ты берёшь на себя роль коменданта базы и 
                единственного стрелка из пушки, заряженной порцией освежающего мороженого. Цель проста — отбить 
                все волны пушистых вечно голодных хищников и не дать им разрушить стены твоего убежища.`,
                target: {type: 'none'},
                trigger: {type: 'next'},
                nextId: 'intro_3',
                modal: true,
